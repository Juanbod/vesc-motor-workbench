...
|---|---:|---:|---:|---:|---|
| diagnostic | 900 | 920.06 | 86.53 | -9.87 | True |

Stop reason: none
Rollback: {"motor_restored": false, "app_output": "disabled until power cycle", "error": "Cannot verify standstill for rollback"}
